        ...
        <div class="col-md-12">
            <div class="">
                <div class="box-content">
                    <div class="text-center"><h2>add slide galary</h2></div>
                    @if(count($errors)>0)
                    ...
                    @endif
                    <form class="form-horizontal" method="POST" action="{{ url('/admin/slide/store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control " name="description" id="editor1" ></input>
                            </div>                            
                        </div>
                        <div class="form-group">
